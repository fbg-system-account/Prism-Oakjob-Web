package com.prism.oakjob.repository;

import com.prism.oakjob.PrismOakjobApp;
import com.prism.oakjob.config.Constants;
import com.prism.oakjob.config.audit.AuditEventConverter;
import com.prism.oakjob.domain.PersistentAuditEvent;
...
import static com.prism.oakjob.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
